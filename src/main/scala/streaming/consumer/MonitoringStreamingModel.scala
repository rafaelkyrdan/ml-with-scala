...
/**
  * A streaming regression model that compares the model performance of two models,
  * printing out metrics for each batch
  *
  */
...
object MonitoringStreamingModel {
  ...
  def main(args: Array[String]) {
    ...
    val ssc = new StreamingContext("local[2]", "Monitoring Streaming Model", Seconds(10))
